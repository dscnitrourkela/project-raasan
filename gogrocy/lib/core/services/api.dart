...
const String BASE_URL="https://gogrocy.in/";

class Apis{

  static String allProducts=BASE_URL+"api/getProducts";
  static String singleProduct=BASE_URL+"api/getProduct";
